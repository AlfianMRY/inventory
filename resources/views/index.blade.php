...
<html lang="en">
    <head>
        ...
        <link
            href="landingpage/img/apple-touch-icon.png"
        ...
        <link
            href="landingpage/vendor/bootstrap/css/bootstrap.min.css"
            rel="stylesheet"
        />
        <link
            href="landingpage/vendor/bootstrap-icons/bootstrap-icons.css"
            rel="stylesheet"
        />
        <link
            href="landingpage/vendor/boxicons/css/boxicons.min.css"
            rel="stylesheet"
        />
        <link
            href="landingpage/vendor/glightbox/css/glightbox.min.css"
            rel="stylesheet"
        />
        <link
            href="landingpage/vendor/remixicon/remixicon.css"
            rel="stylesheet"
        />
        <link
            href="landingpage/vendor/swiper/swiper-bundle.min.css"
            rel="stylesheet"
        />
    ...
    <body>
        ...
        <header id="header" class="fixed-top">
            ...
            >
                ...
                <!-- <a href="index.html" class="logo"><img src="landingpage/img/logo.png" alt="" class="img-fluid"></a>-->
                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        ...
                        <li>
                            <a class="nav-link scrollto o" href="#portfolio"
                                >Portfolio</a
                            >
                        </li>
                        <li>
        ...
        <section id="hero" class="d-flex align-items-center">
            ...
            >
                ...
                <div class="text-center">
                    <a href="{{url('barang')}}" class="btn-get-started scrollto"
                        >Langsung ke Admin</a
                    >
                </div>
            ...
            <section id="about-video" class="about-video">
                <div class="container" data-aos="fade-up">
                    <div class="row">
                        ...
                        >
                            <img
                                src="landingpage/img/about-video.jpg"
                                class="img-fluid"
                                alt=""
                            />
                            <a
                        ...
                        >
                            ...
                            <ul>
                                <li>
                                    <i class="bx bx-check-double"></i> Ullamco
                                    laboris nisi ut aliquip ex ea commodo
                                    consequat.
                                </li>
                                <li>
                                    <i class="bx bx-check-double"></i> Duis aute
                                    irure dolor in reprehenderit in voluptate
                                    velit.
                                </li>
                                <li>
                                    <i class="bx bx-check-double"></i> Voluptate
                                    repellendus pariatur reprehenderit corporis
                                    sint.
                                </li>
                                <li>
                                    <i class="bx bx-check-double"></i> Ullamco
            ...
            <section id="clients" class="clients section-bg">
                <div class="container">
                    <div class="row">
                        ...
                        >
                            <img
                                src="landingpage/img/clients/client-1.png"
                                class="img-fluid"
                                alt=""
                            />
                        </div>
                        ...
                        >
                            <img
                                src="landingpage/img/clients/client-2.png"
                                class="img-fluid"
                                alt=""
                            />
                        </div>
                        ...
                        >
                            <img
                                src="landingpage/img/clients/client-3.png"
                                class="img-fluid"
                                alt=""
                            />
                        </div>
                        ...
                        >
                            <img
                                src="landingpage/img/clients/client-4.png"
                                class="img-fluid"
                                alt=""
                            />
                        </div>
                        ...
                        >
                            <img
                                src="landingpage/img/clients/client-5.png"
                                class="img-fluid"
                                alt=""
                            />
                        </div>
                        ...
                        >
                            <img
                                src="landingpage/img/clients/client-6.png"
                                class="img-fluid"
                                alt=""
                            />
                        </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <img
                                        src="landingpage/img/testimonials/testimonials-1.jpg"
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <img
                                        src="landingpage/img/testimonials/testimonials-2.jpg"
                                        class="testimonial-img"
                                        alt=""
                                    />
                                    <h3>Sara Wilsson</h3>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <img
                                        src="landingpage/img/testimonials/testimonials-3.jpg"
                                        class="testimonial-img"
                                        alt=""
                                    />
                                    <h3>Jena Karlis</h3>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <img
                                        src="landingpage/img/testimonials/testimonials-4.jpg"
                                        class="testimonial-img"
                                        alt=""
                                    />
                                    <h3>Matt Brandon</h3>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <img
                                        src="landingpage/img/testimonials/testimonials-5.jpg"
                                        class="testimonial-img"
                                        alt=""
                                    />
                                    <h3>John Larson</h3>
                    ...
                    >
                        ...
                        >
                            <div class="portfolio-wrap">
                                <img
                                    src="landingpage/img/portfolio/portfolio-1.jpg"
                                    class="img-fluid"
                                    alt=""
                                />
                                <div class="portfolio-info">
                                    ...
                                    <div class="portfolio-links">
                                        <a
                                            href="landingpage/img/portfolio/portfolio-1.jpg"
                        ...
                        >
                            <div class="portfolio-wrap">
                                <img
                                    src="landingpage/img/portfolio/portfolio-2.jpg"
                                    class="img-fluid"
                                    alt=""
                                />
                                <div class="portfolio-info">
                                    ...
                                    <div class="portfolio-links">
                                        <a
                                            href="landingpage/img/portfolio/portfolio-2.jpg"
                                            data-gallery="portfolioGallery"
                                            class="portfolio-lightbox"
                                            title="Web 3"
                                            ><i class="bx bx-plus"></i
                        ...
                        >
                            <div class="portfolio-wrap">
                                <img
                                    src="landingpage/img/portfolio/portfolio-3.jpg"
                                    class="img-fluid"
                                    alt=""
                                />
                                <div class="portfolio-info">
                                    ...
                                    <div class="portfolio-links">
                                        <a
                                            href="landingpage/img/portfolio/portfolio-3.jpg"
                                            data-gallery="portfolioGallery"
                                            class="portfolio-lightbox"
                                            title="App 2"
                                            ><i class="bx bx-plus"></i
                        ...
                        >
                            <div class="portfolio-wrap">
                                <img
                                    src="landingpage/img/portfolio/portfolio-4.jpg"
                                    class="img-fluid"
                                    alt=""
                                />
                                <div class="portfolio-info">
                                    ...
                                    <div class="portfolio-links">
                                        <a
                                            href="landingpage/img/portfolio/portfolio-4.jpg"
                                            data-gallery="portfolioGallery"
                                            class="portfolio-lightbox"
                                            title="Card 2"
                                            ><i class="bx bx-plus"></i
                        ...
                        >
                            <div class="portfolio-wrap">
                                <img
                                    src="landingpage/img/portfolio/portfolio-5.jpg"
                                    class="img-fluid"
                                    alt=""
                                />
                                <div class="portfolio-info">
                                    ...
                                    <div class="portfolio-links">
                                        <a
                                            href="landingpage/img/portfolio/portfolio-5.jpg"
                                            data-gallery="portfolioGallery"
                                            class="portfolio-lightbox"
                                            title="Web 2"
                                            ><i class="bx bx-plus"></i
                        ...
                        >
                            <div class="portfolio-wrap">
                                <img
                                    src="landingpage/img/portfolio/portfolio-6.jpg"
                                    class="img-fluid"
                                    alt=""
                                />
                                <div class="portfolio-info">
                                    ...
                                    <div class="portfolio-links">
                                        <a
                                            href="landingpage/img/portfolio/portfolio-6.jpg"
                                            data-gallery="portfolioGallery"
                                            class="portfolio-lightbox"
                                            title="App 3"
                                            ><i class="bx bx-plus"></i
                        ...
                        >
                            <div class="portfolio-wrap">
                                <img
                                    src="landingpage/img/portfolio/portfolio-7.jpg"
                                    class="img-fluid"
                                    alt=""
                                />
                                <div class="portfolio-info">
                                    ...
                                    <div class="portfolio-links">
                                        <a
                                            href="landingpage/img/portfolio/portfolio-7.jpg"
                                            data-gallery="portfolioGallery"
                                            class="portfolio-lightbox"
                                            title="Card 1"
                                            ><i class="bx bx-plus"></i
                        ...
                        >
                            <div class="portfolio-wrap">
                                <img
                                    src="landingpage/img/portfolio/portfolio-8.jpg"
                                    class="img-fluid"
                                    alt=""
                                />
                                <div class="portfolio-info">
                                    ...
                                    <div class="portfolio-links">
                                        <a
                                            href="landingpage/img/portfolio/portfolio-8.jpg"
                                            data-gallery="portfolioGallery"
                                            class="portfolio-lightbox"
                                            title="Card 3"
                                            ><i class="bx bx-plus"></i
                        ...
                        >
                            <div class="portfolio-wrap">
                                <img
                                    src="landingpage/img/portfolio/portfolio-9.jpg"
                                    class="img-fluid"
                                    alt=""
                                />
                                <div class="portfolio-info">
                                    ...
                                    <div class="portfolio-links">
                                        <a
                                            href="landingpage/img/portfolio/portfolio-9.jpg"
                                            data-gallery="portfolioGallery"
                                            class="portfolio-lightbox"
                                            title="Web 3"
                                            ><i class="bx bx-plus"></i
                    ...
                    <div class="row">
                        ...
                        >
                            <div class="member">
                                <div class="member-img">
                                    <img
                                        src="landingpage/img/team/team-1.jpg"
                                        class="img-fluid"
                                        alt=""
                                    />
                                    <div class="social">
                        ...
                        >
                            <div class="member">
                                <div class="member-img">
                                    <img
                                        src="landingpage/img/team/team-2.jpg"
                                        class="img-fluid"
                                        alt=""
                                    />
                                    <div class="social">
                        ...
                        >
                            <div class="member">
                                <div class="member-img">
                                    <img
                                        src="landingpage/img/team/team-3.jpg"
                                        class="img-fluid"
                                        alt=""
                                    />
                                    <div class="social">
                        ...
                        >
                            <div class="member">
                                <div class="member-img">
                                    <img
                                        src="landingpage/img/team/team-4.jpg"
                                        class="img-fluid"
                                        alt=""
                                    />
                                    <div class="social">
                        ...
                        <div class="col-lg-8 mt-5 mt-lg-0">
                            ...
                            >
                                <div class="row">
                                    ...
                                    <div
                                        class="col-md-6 form-group mt-3 mt-md-3"
                                    >
                                        <input
                                            type="email"
                                            class="form-control"
