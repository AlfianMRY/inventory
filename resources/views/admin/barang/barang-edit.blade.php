    ...
    <div class="row">
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" value="{{ $barang->nama }}" name="nama" id="simpleinput" class="form-control">
            </div>
        </div> 
        <div class="col-md-6">
            <div class="mb-3">
                <label for="simpleinput" class="form-label">Kode Barang :</label>
                <input type="text" value="{{ $barang->kode }}" name="kode" id="simpleinput" class="form-control">
            </div>
        </div> 
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <select name="kategori" class="form-select" id="example-select">
                    @foreach ($kategori as $k)
                        <option {{ $k->id == $barang->kategori_id ? 'selected' : '' }} value="{{ $k->id }}">{{ $k->nama }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="number" value="{{ $barang->stock }}" name="stock" id="simpleinput" class="form-control">
            </div>
        </div> 
        <div class="col-md-6">
            <div class="mb-3">
